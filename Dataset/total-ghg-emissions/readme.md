...
This data package contains the data that powers the chart ["Greenhouse gas emissions"](https://ourworldindata.org/grapher/total-ghg-emissions?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 27, 2024.
